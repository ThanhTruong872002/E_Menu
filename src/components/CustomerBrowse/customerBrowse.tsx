...
export default function CustomerBrowse() {
  return (
    <div className="text-center w-full md:w-[90%] mx-auto mb-[120px]">
      <h2 className="text-5xl font-sans lg:text-7xl font-medium my-10 md:my-20">
        Browse Our Menu
      </h2>
      <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-10">
        <div className="w-[80%] mx-auto lg:w-[100%] md:w-[306px] md:h-[375px] rounded-2xl border border-solid border-[#ccc] p-8">
