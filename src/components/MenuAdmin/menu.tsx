...
const Menu: React.FC = () => {
  ...
  useEffect(() => {
    const fetchMenuData = async () => {
      try {
        const response = await axios.get("https://139.180.187.232:4000/api/menu");
  ...
  const handleDeleteMenuItem = async (menuItemId: string, menuItemName: string) => {
    ...
    if (confirmDelete) {
      try {
        ...
        await axios.delete(`https://139.180.187.232:4000/api/deleteDish/${menuItemId}`);
                ...
                <React.Fragment key={index}>
                  ...
                  >
                    <td className="p-4">
                      ...
                      >
                        <img
                          src={`https://139.180.187.232:4000/uploads${menuItem.Image}`}
